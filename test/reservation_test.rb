...
describe Reservation do
 ...
 before do
  ...
  test_start_date = Time.parse("2019/09/20")
  test_end_date = Time.parse("2019/09/25")
 ...
 it "instance of reservation start time and end time to be a kind of Time" do
  expect(@test_reservation.start_date).must_be_kind_of Time
  expect(@test_reservation.end_date).must_be_kind_of Time
 end
 
 it "instance of reservation knows the value of its start and end dates" do
  expected_start_date = Time.parse("2019/09/20")
  expected_end_date = Time.parse("2019/09/25")
 ...
 it "instance of reservation knows its cost" do
  ...
  expected_test_trip_cost = test_trip_duration * SEC_TO_DAY_CONVERSION * test_room_cost
